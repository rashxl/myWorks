...
MObject curveWave::mesh;
MObject curveWave::curve;
MObject curveWave::scale;
MObject curveWave::outMesh;
MObject curveWave::env;
MObject curveWave::waveFallOff;
MObject curveWave::scaleFallOff;
MObject curveWave::num;
MObject curveWave::offset;
MObject curveWave::shift;
MObject curveWave::amount;
MObject curveWave::len;

MTypeId curveWave::id(0x003300128);

void * curveWave::creator(){

	return new curveWave;
}


MStatus curveWave::initialize(){
...
MStatus curveWave::compute(const MPlug& plug, MDataBlock & data){
	MStatus stat;
